...
export const perfumes: Perfume[] = [
  ...
  },
  {
    ...
    story: "Uma escultura vítrea que captura a essência do sol em seu zênite. Fulgor Dourado é um perfume solar e opulento que irradia calor e luxo.",
    categories: ["Oriental", "Gourmand"]
  },
  {
    id: 332,
    name: "Coração de Cobalto",
    designer: "Aura Maris",
    imageUrl: "https://i.imgur.com/FyILcHJ.jpg",
    year: 2024,
    notes: {
      top: ["Sal Marinho", "Bergamota"],
      heart: ["Lótus Azul", "Algas"],
      base: ["Almíscar Branco", "Madeira Flutuante"]
    },
