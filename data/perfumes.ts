...
export const perfumes: Perfume[] = [
  ...
  // Fix: Completed the missing properties and closed the array
  {
    id: 15,
    ...
    notes: {
      ...
      heart: ["Rosa Turca", "Absoluto de Jasmim", "Fava de Baunilha"],
      base: ["Oud", "Âmbar Cinzento", "Patchouli"],
    },
    story: "Um néctar sedutor de frutas vermelhas e especiarias nobres. Elixir Carmesim é uma jornada sensorial através de jardins proibidos, onde a doçura da cereja encontra a profundidade terrosa do oud.",
